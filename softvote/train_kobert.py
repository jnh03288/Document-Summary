...
train_dataset = BertCustomDataset(data_dir=DATA_DIR, mode='train')
validation_dataset = BertCustomDataset(data_dir=DATA_DIR, mode='val')
...
scheduler = optim.lr_scheduler.OneCycleLR(optimizer=optimizer, pct_start=0.1, div_factor=1e5, max_lr=config['TRAIN']['learning_rate'], epochs=EPOCHS, total_steps=EPOCHS, verbose=True)
