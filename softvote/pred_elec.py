...
random.seed(42)
DATA_DIR = './data/elec'
TRAINED_MODEL_PATH = './results/train/elec/best.pt'
BATCH_SIZE = 4
# Set device
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

# Load dataset & dataloader
test_dataset = ElectraCCustomDataset(data_dir=DATA_DIR, mode='test')
...
# Predict
preds1 = trainer1.test_epoch(test_dataloader, epoch_index=0)

with open("elec.pkl", 'wb') as f:
