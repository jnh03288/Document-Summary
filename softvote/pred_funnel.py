...
np.random.seed(42)
random.seed(42)
DATA_DIR = './data/funnel'
TRAINED_MODEL_PATH = './results/train/funnel/best.pt'
BATCH_SIZE = 4
# Set device
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

# Load dataset & dataloader
test_dataset = FunnelCCustomDataset(data_dir=DATA_DIR, mode='test')
...
# Predict
preds2 = trainer1.test_epoch(test_dataloader, epoch_index=0)
